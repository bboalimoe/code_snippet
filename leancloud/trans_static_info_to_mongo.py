...
for times in range(count_query.count() / 100 + 1):
    ...
    for object in objects:
        ...
        object["user_id"] = id
        print object
        #db.UserStaticInfo.insert_one(object)
        new_objs.append(object)
    db.UserStaticInfo.insert_many(new_objs)
