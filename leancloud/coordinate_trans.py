...
def wgs84togcj02(lng, lat):
    ...
    print type(dlat), type(a),type(ee), type(magic), type(sqrtmagic), type(pi)
...
def wrong_baidu_to_right_baidu(location):
...
if __name__ == '__main__':
    caonima = 39.9251467,116.4341874
    lng = 116.4341874
    lat = 39.9251467
    # 116.440451073 39.9264230356
    print wrong_baidu_to_right_baidu({"lat":lat, "lng":lng})
